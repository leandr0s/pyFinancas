...
SYMBOL = "ENEV3"  # Substitua pelo símbolo desejado
...
PROFIT_MARGIN = 10.0  # Margem de lucro em reais
LOSS_THRESHOLD = -10.0  # Margem de prejuízo por operação
CONSECUTIVE_LOSS_THRESHOLD = 20  # Número de perdas consecutivas para vendaq
DELAY_LOSS = 500
